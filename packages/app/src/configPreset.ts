...
const presetValues: Record<PresetName, Record<string, string>> = {
  openai: {
    ...
    "llm.tool_choice.mode": "force",
    "llm.request.timeout_ms": "100000",
    "llm.base_url": "",
    "llm.api_key.env_name": "OPENAI_API_KEY",
  },
  zai: {
    ...
    "llm.tool_choice.mode": "force",
    "llm.request.timeout_ms": "100000",
    "llm.base_url": "https://api.z.ai/api/paas/v4/",
    "llm.api_key.env_name": "ZAI_API_KEY",
  },
  deepseek: {
    ...
    "llm.api_key.env_name": "DEEPSEEK_API_KEY",
  },
  moonshot: {
    ...
    "llm.tool_choice.mode": "auto",
    "llm.request.timeout_ms": "100000",
    "llm.base_url": "https://api.moonshot.ai/v1",
    "llm.api_key.env_name": "MOONSHOT_API_KEY",
  },
}
